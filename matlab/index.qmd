...
- **加减:** 向量加减，如果项数不同，在项数较少的前面补0
- **乘法:** `conv(p1,p2)`表示多项式p1, p2的乘积。
- **除法:** `[q, r] = deconv(p1, p2)`，其中`q`是商，`r`是余数
...
![](images/manual_plot.png){width=30% fig-align="center"}
...
![](images/plot_options.png){width=80%}
...
::: {.column width="40%"}
![](images/polar_sample.png){width=80%}
:::
::::
