...
# 数据定义
mass = np.array([50, 100, 150, 200, 250, 300, 350, 400, 450, 500, 550])
length = np.array([1.0, 1.875, 2.75, 3.25, 4.375, 4.875, 5.675, 6.5, 7.25, 8.0, 8.75])

# 计算斜率
k = (length[5] - length[3]) / (mass[5] - mass[3])

# 创建图形
plt.figure()

# 绘制直线
plt.plot([0, 600], [0, k * 600], color='green', linewidth=2)

# 绘制点
plt.plot(mass, length, color='black', linestyle='None', marker='o', markersize=2)

# 绘制特定点
plt.plot(mass[[3, 5]], length[[3, 5]], color='red', linestyle='None', marker='o', markersize=5)

# 添加注释
plt.annotate('e = 0.01625m', xy=(350, 5.5), xytext=(320, k*320 - 2),
